...
public class BuiltInInterfaceExamples {
    public static void main(String[] args) {
        ...
        // Executing methods with built-in interface arguments... no output on executing below but compiled.
        createAndAddItem(list, s6);
        createAndAddItem(list, s7);

        createAndAddItem(list,(Predicate<List>)
...
//        Item i = createItem("Test", Item::new); because of ambiguity methods else no error
        Item i = createItem("Test", (Function<String,Item>) Item::new);
        i = createItem("Test", (Supplier<Item>) Item::new);
    }
