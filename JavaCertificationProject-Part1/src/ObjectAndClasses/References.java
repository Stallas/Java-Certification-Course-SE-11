...
/*
    ...
    Sub-Topic: 1. Object references
 */

// A simple test class with few attributes , a constructor and a method.
class TestClass{
    private String a = "a";
    private String b = "b";
    // Constructor
...
public class References {
    public static void main(String[] args) {
        ...
        // any references to the 'a-z object' is no longer exist after statement
        aref = bref;
        System.out.println("aref has a reference to object : "+ aref);
        // aref,bref,dref all reference to 'first-last' object
        dref = bref;
        System.out.println("dref has a reference to object : "+ dref);

        // Assignments not in declarations occur right to left
        // eref,bref,cref all reference to 'start-end' object
        eref = bref = cref;
        System.out.println("eref has a reference to object : "+ eref);

        // all references to 'start-end' object are set to null,making eligible for garbage collection
        aref = dref = null;
