...
public class WildcardExample {
    ...
    // Objects
//    Compiler error if Passes Integer, or Exception or Runtime and hence using printOpenDoor
...
//        printObjectList(integerList);
        ...
        printObjectList(objectList2); // we can always cast a generic type to raw type
        ...
        // Suppose we rename both printLowerList,printUpperList to printList.meaning overloaded
        // we get compiler error as both have same erasure ,ultimately both are same List no matter
        // of upper or lower bounds. As a result, you cant overload methods using type parameters.
    }
}