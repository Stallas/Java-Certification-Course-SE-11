...
//    public <? extends WildcardTests> void doSomething(){
...
//        WildcardTests.<?>doSomething("Hello");//as a type argument for a generic method invocation or
...
//        You cant use a wildcard to instantiate a generic class

    }
}
/*
class AnotherClassTest extends WildcardTests<?> {
    // You cant use a wildcard to specific a super type.
}
 */
/*
class AnotherClassTest <? extends WildcardTests> {
    // You cant use a wildcard in a type argument of a generic class.
}
 */
