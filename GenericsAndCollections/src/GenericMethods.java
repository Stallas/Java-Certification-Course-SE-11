...
// Apple class implements Comparable of a generic type Apple.
...
public class GenericMethods {
    ...
    public static void main(String[] args) {
        ...
        /*
        // You know at compile time that you cannot compare Apples and Oranges, but still you try...
        System.out.println("\n-------- Compare Apple to Orange -----");
        System.out.println("compareObjects(Orange,Apple): Match = "
                + (g.compareObjects(
                new Orange(1), new Apple(1)) == 0));

        // A compile-time is better than a run time error.
