...
//        stream2.forEach(System.out::println);
        ...
        // illegalstateexception i.e. stream is already upon/closed. At this point, both stream1 and stream2 are closed
//       try commenting foreach of both stream1 and stream2
...
//        stream1 = stream1.sorted(Comparator.reverseOrder());
        ...
        tree1.add("Zoe");//.ConcurrentModificationException
