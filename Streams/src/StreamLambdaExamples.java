...
//  Suppose, add parameter int c or change return type to long we get compiler error... follows BinaryOperator
                        .reduce(Integer::sum).get());

//        BinaryOperator bi = (int a, Integer b) -> a+b;
        // we get compiler error over here but not in sum method. it is more forgiving in case of
//        method reference than lambda expression.
