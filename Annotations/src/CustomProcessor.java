...
//            Using getElementsAnnotatedWithAny which checks for inherited annotations
            System.out.println(annotation);
            for(Element element : roundEnv.getElementsAnnotatedWithAny(annotation)){

                info = "\t" + element.getKind() + " : " +
//                        Strip out unnamed package information using ternary operator
                        ((element.getEnclosingElement().toString().indexOf("unnamed") > -1)
