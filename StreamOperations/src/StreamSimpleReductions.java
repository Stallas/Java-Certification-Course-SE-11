...
//                    .get() //when limit=0,i.e. list is empty then NoSuchElementException ... works well when initial limit=1
                    .orElse(-1);
...
//                    .reduce(Integer::sum) // is same as below
//                    .reduce((a,b)->a+b) // is same as below
