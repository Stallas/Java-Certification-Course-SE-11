...
public class StreamGrouping {
    public static void main(String[] args) {
        ...
        /*
        This actual 2 statements combined into one. output of grouping by type is stream processed to map.
        ...
        // Using a single stream pipeline, compare the code snippets of previous one.
        petPopulation.stream()
