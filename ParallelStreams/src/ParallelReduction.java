...
public class ParallelReduction {
    ...
    public static void main(String[] args) {
        ...
        avg = Stream.iterate(0, i -> i <= 10000, i -> i + 1)
                .parallel()
                .mapToInt(s -> s)
                .average().getAsDouble();// avg returns OptionalDouble to retrieve getAsDouble
...
//                .parallel()
                ...
                .reduce(0, (s1, s2) -> s1 + s2, (s1, s2) -> s1); // s1 + s2
        System.out.println("serial sum using lambda expression " +
