...
//        };
        ...
        // Anonymous class implements interface Doable. Here, we are executing some method and not assigning to any field/variable.
        new Doable() {
            public void doSomething() {
        ...
        // class. AnonymousClass cannot have constructors but abstract classes can have.
