...
//    public void printSomeAdditionalInfo() { // then can access when invoked.....not given but i have tried to see the result
//        System.out.println("Two pinochles is rare and is 30 points");
//    }
}
...
class PinochleGame {
    ...
    public static void main(String[] args) {
        ...
        for (PinochleMeld points : hand) {//PinochleMeld.values()

            // call method on the enum constant
            points.describe();
            System.out.println(points.adjustScore());
