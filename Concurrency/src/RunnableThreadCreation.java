        ...
        try {
            infiniteStream.forEach(s -> {
                ...
                try {
                    ...
                    Thread.sleep(500); // Static method Thread.sleep() not regular sleep() method
...
public class RunnableThreadCreation {
    public static void main(String[] args) throws InterruptedException {
        ...
        // of NumberGenerator class... Both gives same result, we can use method reference or lambda exp
        // for run() method
