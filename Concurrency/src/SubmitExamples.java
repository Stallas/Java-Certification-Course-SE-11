...
public class SubmitExamples {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Submits lambda exp as Runnable and returns void
            ...
            // time. Similar to wait in which case one of 3 events occur.
            // tasks done, timeout ,InterruptedException. compiler error if undefined this exception in catch block.
