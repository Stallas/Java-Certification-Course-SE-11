...
//                neighbor.name+" to respond before releasing lock");
        ...
        /*
        lock on current instance will not be released until this method completes,
        but respond cannot be invoked because the neighbor instance is blocked waiting
        for current instance to unlock.
         */
        neighbor.respond(this);
    }

    // synchronized method cannot execute if the instance is locked,
    // Must wait for lock on instance to be released .synchronized
...
public class DeadLockExample {
    ...
    public static void main(String[] args) {
        ...
        new Thread(() -> she.greet(she)).start();
    }
}