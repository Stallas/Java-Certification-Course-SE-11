...
class MyCustomThread extends Thread {
    ...
    MyCustomThread(String threadName, int seed) {
        // Chaining Thread constructor, passing thread name. else default Thread-0,Thread-1 will
...
public class CustomThreadCreation {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // Pauses current thread (main thread)for 3 seconds allowing other asynchronous
