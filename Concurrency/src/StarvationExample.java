        ...
        public void run() {
            ...
            while (true) {
                ...
                synchronized (sharedObject) {
                    ...
                    counter++;
                    try {
                        // Use Thread.sleep to consume a bit of time, to keep shared
                        // object blocked.we see one thread gets more resource than other.
//                        Thread.sleep(200);

                        // Thread waits until awakened, typically by being notified
                        // or interrupted, or until time specified has elapsed.
                        // releases the lock and waits for the period of time.
