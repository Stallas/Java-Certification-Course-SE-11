...
public class LambdaExample3 {
    ...
    public static void main(String[] args) {
        ...
        //compiler error if i++ because variable used in lambda exp should be final or effectively final.
        int i = 10;
        ...
        int k = 0;
//        Runnable r5 = (k) -> k + 1;// we should not use variable declarations in the method parameters of the lambda exp.
